"""
Importing all relevant functions including the pyspark SQL function. Additionally importing the monotonically_increasing_id to assign row numbers to the pyspark dataframe
"""
...
"""
    ...
    songplays_table = df.join(song_df, (df.song == song_df.title)\
                             ...
                             & (df.length == song_df.duration), "inner").distinct()\
